...
TEMPORAL_REGIONS_PTV_CAR02 = {
    ...
    3: [
        PTVTemporalRegion(name="sin_carbopol",     start_time=0.0,  end_time=0.5,  skip_frames=10, fps=220.0, max_dist_mm=3.0),
...
TEMPORAL_REGIONS_PTV_CAR05 = {
    ...
    3: [
        PTVTemporalRegion(name="sin_carbopol",           start_time=0.0,  end_time=10,  skip_frames=10, fps=220.0, max_dist_mm=3.0),
